...
class SubjectiveTest:
    ...
    def generate_test(self):
        ...
        # Check if keyword_list is not empty before proceeding
        if keyword_list:
            for _ in range(min(int(self.noOfQues), len(keyword_list))):
        ...
        # Check if question_answer is not empty before entering the loop
        if question_answer:
